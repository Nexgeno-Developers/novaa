...
export async function POST(request: Request) {
  try {
    ...
    // Comprehensive revalidation for new projects with stale-while-revalidate
    revalidatePath("/", "page"); // Home page
    revalidatePath("/project", "page"); // Projects page
    revalidatePath(`/project-detail/${slug}`, "page"); // New project detail page
    revalidatePath(`/api/projects/slug/${slug}`, "page"); // API route for the new project
    revalidatePath(`/api/cms/projects/slug/${slug}`, "page"); // CMS API route
