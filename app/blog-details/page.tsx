...
export default function Blogdetails() {
  return (
    <>
      ...
      <section className="w-full py-10 px-4 pt-25 bg-[#F8F6ED]">
        <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row items-start justify-between gap-6 lg:gap-12">
          ...
          <div className="w-full lg:w-[354px] h-[522px] bg-[#072D2C] border border-[#CDB04E] rounded-[20px] p-4 overflow-y-auto">
            {/* Heading */}
            <h3 className="text-[#CDB04E] text-[20px] pt-6 font-bold leading-[100%] text-left mt-2">
    ...
    <div className=" w-full py-10 pt-18 px-4">
  <div className="max-w-[841px] ">
    <h2
      className="text-[35px] leading-[100%] text-[#072D2C] font-bold mb-6"
    ...
    <p
      className="text-[16px] text-[#072D2C] font-light leading-[130%] mb-4"
     
    >
      is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
      industry standard dummy text ever since the 1500s, when an unknown printer took a galley
      of type and scrambled it to make a type specimen book. It has survived not only five
      centuries, but also the leap into is simply dummy text of the printing and typesetting
    ...
    <p
      className="text-[16px] text-[#072D2C] font-normal leading-[130%] mb-4"
      
    >
      <strong>is simply dummy text of the printing and typesetting industry.</strong>
    </p>
