      ...
      <section className="w-full py-10 px-4 pt-25 bg-[#F8F6ED]">
        ...
        <div className=" w-full py-10 pt-18 px-4">
          <div className="max-w-[841px] ">
            <h2 className="font-cinzel text-[35px] leading-[100%] text-[#072D2C] font-bold mb-6">
              Maximizing ROI with Phuket Holiday Homes
            </h2>

            <p className="font-josefin text-[16px] text-[#072D2C] font-light leading-[130%] mb-4">
            ...
            <p className="text-[16px] text-[#072D2C] font-normal leading-[130%] mb-4">
              <strong>
                is simply dummy text of the printing and typesetting industry.
              </strong>
            </p>

            <p className="text-[16px] text-[#072D2C] font-light leading-[130%] mb-4">
              is simply dummy text of the printing and typesetting industry.
              Lorem Ipsum has been the industry standard dummy text ever since
              the 1500s, when an unknown printer took a galley of type and
