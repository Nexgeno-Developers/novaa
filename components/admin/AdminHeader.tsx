...
//               <DropdownMenuContent
//                 align="end"
//                 className="admin-theme w-48 bg-card/95 backdrop-blur-sm border-border/50"
//               >
...
//               <DropdownMenuContent
//                 align="end"
//                 className="admin-theme w-96 bg-card/95 backdrop-blur-sm border-border/50 shadow-xl"
//               >
...
//               </DropdownMenuTrigger>
//               <DropdownMenuContent
//                 className="admin-theme w-64 bg-card/95 backdrop-blur-sm border-border/50 shadow-xl"
//                 align="end"
//                 forceMount
//               >
      ...
      <div className="flex w-full items-center justify-between h-full">
        ...
        <div className="flex flex-col justify-center min-w-0 flex-1 sm:flex-initial">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <h1 className="text-lg sm:text-xl lg:text-2xl font-bold text-primary/90 tracking-tight truncate">
              {getPageTitle()}
            </h1>
            <Badge
              variant="outline"
        ...
        <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3 shrink-0">
          ...
          <Button
            variant="ghost"
            size="sm"
            className="lg:hidden h-8 w-8 sm:h-10 sm:w-10 rounded-xl hover:bg-accent/20 transition-all duration-300"
            onClick={() => setCommandOpen(true)}
          >
          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  size="sm"
                  className="h-8 w-8 sm:h-10 sm:w-10 bg-primary hover:bg-primary/90 text-primary-foreground rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                >
