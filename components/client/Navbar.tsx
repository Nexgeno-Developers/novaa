            ...
            <nav className="flex items-center space-x-10 font-josefin text-lg font-normal">
              {mainNavItems.map((item, idx) => {
                ...
                const activeSubmenuItems = hasSubmenu 
                  ? item.submenu?.filter(sub => sub.isActive).sort((a, b) => a.order - b.order)
                  : [];
                ...
                return (
                  <div
                    ...
                    onMouseEnter={() => hasSubmenu && setActiveSubmenu(item._id!)}
                        ...
                        >
                          <div className="relative">
                            ...
                            <div className="relative p-2">
                              {activeSubmenuItems && activeSubmenuItems.map((subItem, subIdx) => (
                                <motion.div
                                  key={subItem._id}
                                ...
                                >
                                  <Link
                                    ...
                                    className={cn(
                                      ...
                                      pathname === subItem.href && "text-[#F0DE9C] bg-white/10"
                                    )}
                                  >
                    ...
                    <div key={item._id} className="border-b border-white/10">
                      ...
                      {hasSubmenu && (
                        <div className="pl-4 pb-2 space-y-1">
                          {activeSubmenuItems && activeSubmenuItems.map((subItem) => (
                            <Link
                              key={subItem._id}
                              href={subItem.href}
                              className={cn(
