    ...
    <>
      <header className="absolute top-0 w-full bg-background lg:bg-[#00000099] z-20 text-white">
        <div className="relative">
          ...
          <div
            className="absolute right-0 top-0 h-20 bg-[#00000033] border border-[#00000033] 
               lg:[width:calc((100vw-1536px)/2+560px)]
               xl:[width:calc((100vw-1536px)/2+420px)]"
          ></div>
            ...
            <div className="hidden lg:flex items-center space-x-10 h-full">
              ...
              <div className="flex items-center justify-center h-full relative z-10">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-[#C3912F] to-[#F5E7A8] shadow-lg transition-all cursor-pointer group"
