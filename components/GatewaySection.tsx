      ...
      <div className="container">
        <div className="relative z-20 py-10 sm:py-20">
          <div className="font-cinzel flex flex-col lg:flex-row items-start">
                  ...
                  {Object.keys(explorerData).map((key) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full sm:w-[80%] flex items-center space-x-4 p-4 rounded-[20px] border border-[#CDB04E1A] transition-all duration-300 group cursor-pointer bg-[#CDB04E1A] text-[#CDB04E] hover:border-[#C3912F] ${
                          isActive
            ...
            <div className="w-full lg:w-[40%] h-[400px] sm:h-[500px] lg:h-[1000px] flex  items-center justify-center">
              <motion.div
              ...
              >
                <Image src={"/images/map2.png"} alt="map" fill className="object-contain" />
