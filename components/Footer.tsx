      ...
      <footer className="relative w-full bg-[#000000D9] overflow-hidden pt-10 pb-5 sm:pb-10 sm:pt-20">
        ...
        <div className="container mx-auto relative z-40 flex flex-col justify-center items-center text-white ">
          ...
          <div className=" text-center mb-4 sm:mb-10 lg:mb-16">
            ...
            <h2
              className="font-cinzel text-2xl sm:text-3xl lg:text-[50px] font-bold mb-6 
            ...
            <div className="inline-block">
              <button className="group relative bg-[#30303033] border-3 border-[#F0DE9C] text-[#F0DE9C] px-6 py-3 sm:px-8 sm:py-4 rounded-full hover:bg-[#30303033] hover:text-[#ebd78d] transition-all duration-300 flex flex-col items-center gap-1 text-base sm:text-lg font-medium text-center cursor-pointer">
                <span>Explore</span>
